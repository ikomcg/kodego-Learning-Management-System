...
if(isset($_SESSION["Account"])){
    ...
    echo ' <script>window.location.href = "http://localhost/kodegoeLMS/user_dashboard/room.php"</script>';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <script src="database/js/forgot.js"defer></script>
         ...
         <div class="wrap">
             <div class="header d-flex flex-row justify-content-between align-items-center">
                 <div class="left-header d-flex align-items-center">
                    ...
                    <span class="mt-3 mb-2" style="margin-left: 10px;">Kodego Education Learning Management System</span>
                 </div>
                        ...
                        <div class="forms" style="text-align: left;">
                            ...
                            <div>
                                <div class="d-flex justify-content-between mt-3 mb-3">
                                    <div>
                                        <button id="btn_forgotPassword" type="submit" class="btn btn-primary">Continue</button>
                                    </div>
