            ...
            <div class="wrap d-flex flex-row justify-content-between align-items-center">
                ...
                <div class="right-user">
                    ...
                    <div class="box-acc" id="logout-box">
                        ...
                        <img style="height: 60px;" src="../upload/profile_img/<?php img_user(); ?>" style="margin-right: 15px; clip-path: circle();" alt="">
                        </div>
                        <div class="inf-acc">
                            <h2><?php name(); ?></h2>
        ...
        <section class="dashboard">
            <div class="wrap d-flex ">
                ...
                <div class="content-modul">
                    ...
                    <div class="btn_course d-flex justify-content-between">
                        <ul class="d-flex">
                            <li class="modules"><a href="">Modules</a></li>
                            <li ><a href="assignment.php?course=<?php echo $resultInfo['Course_Name']; ?>&ID=<?php echo $courseID?>">Assignment</a></li>
                            <?php 
                    ...
                    <div class="content-modules">
                        ...
                        <div class="module d-flex justify-content-between align-items-center" style="margin-top: 10px;">
                           <span style="font-size:18px; padding-top:5px;padding-bottom:5px;">Modules</span>
                           <?php module_upload($courseID,$courseName,$resultInfo); ?>
                        </div>
                        <div>
                            <ul>
                                <?php modules($courseID)?>
                            </ul>
                        </div>
                    </div>
