...
if(isset($_GET['ID'])){
    ...
    $courseCode = $resultInfo['Course_Code'];
            ...
            <div class="wrap d-flex flex-row justify-content-between align-items-center">
                ...
                <div class="right-user">
                    ...
                    <div class="box-acc" id="logout-box">
                        <div class="img-acc" style="margin-right:10px;">
                        <img  src="../upload/profile_img/<?php img_user(); ?>" style="margin-right: 15px; clip-path: circle(); height:60px;" alt="">
                        </div>
                        <div class="inf-acc">
                            <h2><?php name(); ?></h2>
                            ...
                            <div class="btn-acc">
                                <form action="../../database/logout.php" method="POST">
                                    <button id="logout-accnt" name="btn-logout" type="submit">Log-out</button>
                                </form>
                            </div>
        ...
        <section class="dashboard">
            <div class="wrap d-flex ">
                ...
                <div class="content-modul">
                    ...
                    <div class="btn_course d-flex justify-content-between position-relative mt-3">
                        <ul class="d-flex">
                            <li><a href="javascript: history.back()">Modules</a></li>
                            <li class="assigment"  ><a href="" onclick="history.back()">Assignment</a></li>
                            <li ><a href="student_grade.php?course=<?php echo $courseName?>&ID=<?php echo$courseID ?>&courseCode=<?php echo$resultInfo['Course_Code'] ?>">Grade</a></li>
                        </ul>
                        <!-- <button id="open_module"><i class="bi bi-plus"></i></button>
                        <div id="form_module" class="form_module w-50" style="position: absolute; background-color:antiquewhite; right: 0; top: 0;box-shadow: rgba(0, 0, 0, 0.07) 0px 1px 2px, rgba(0, 0, 0, 0.07) 0px 2px 4px, rgba(0, 0, 0, 0.07) 0px 4px 8px, rgba(0, 0, 0, 0.07) 0px 8px 16px, rgba(0, 0, 0, 0.07) 0px 16px 32px, rgba(0, 0, 0, 0.07) 0px 32px 64px; padding: 10px; border-radius: 5px ; overflow: hidden; color: black;"> -->
                            ...
                            <!-- <form action="">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="moduleName" placeholder="Assignment Title">
                                  </div>
                                  <div class="mb-3">
                                    <input class="form-control" type="file" id="formFile">
                                  </div>
                                  <button type="submit" style="background-color: #14599d; color: #ffffff; border: none; padding: 2px 40px; float: right; font-size: 18px;">Upload</button>
                        ...
                        <table class="content-assigment w-100">
                            ...
                            <?php student_view_submitted($assID, $courseName, $courseID, $courseCode );?>
                    </table>
                </div>
