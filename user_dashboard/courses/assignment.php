                ...
                <div class="content-modul">
                    ...
                    <div class="btn_course d-flex justify-content-between ">
                        ...
                        <ul class="d-flex">
                            ...
                            <li class="assigment" ><a href="">Assignment</a></li>
                            <?php 
                        ...
                        <?php  add_assignment($courseID, $courseName)?>
                    </div>
                    <?php 
                    $user_type = $_SESSION['user_type'];
                        if($user_type == 'Student'){
                            assignment_student($courseID, $courseName);
                        }
                        else{
                            assignment_teacher($courseID, $courseName);
                        }
