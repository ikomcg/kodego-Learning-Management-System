...
<head>
    ...
    <script src="data/js/join_course.js" defer></script>
    <script src="js/add_courses.js" defer></script>
    ...
    <div>
            ...
            <div class="wrap d-flex flex-row justify-content-between align-items-center">
                ...
                <div class="right-user">
                    ...
                    <button id="show-box-logout">
                        <span class="name_student" id="name_user"> 
                            <?php name(); ?> 
        ...
        <section class="dashboard">
            <div class="wrap d-flex ">
                ...
                <div class="nav-bar" id="nav-bar-left">
                ...
                <div class="right-modul">
                    <div class="calendar">
                        <div>
                            <span style="font-size: 25px; font-weight: 200; margin-left:10px">October 2022</span >
                        </div>
                        <table>
                            <tr>
                                <th>Sun</th>
