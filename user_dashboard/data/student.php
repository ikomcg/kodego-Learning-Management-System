...
function student(){
    ...
    $sqlemail = "SELECT * FROM account WHERE Course_Code = '$courseCode' AND User_Type='Student'";
    ...
    while($result_student = mysqli_fetch_array($resultStudent)){
        ...
        <div class="card-col p-2">
            ...
            <button><a href= "student_edit.php?ID='.$result_student['account_ID'].'">View</a></button>
            </div>
        </div>
    </div>';
    }
